...
Note: the `session_store` kwarg is added in the same release as the Postgres adapter. If your version doesn't accept it, see the [server API reference](/docs/reference/server-api) for the current wiring.
